...
function esVocal(letra) {
  ...
  else if (letra.length = 'a' ) return 'Es vocal'
  else if (letra.length = 'e' ) return 'Es vocal'
  else if (letra.length = 'i' ) return 'Es vocal'
  else if (letra.length = 'o' ) return 'Es vocal'
  else if (letra.length = 'u' ) return 'Es vocal'
